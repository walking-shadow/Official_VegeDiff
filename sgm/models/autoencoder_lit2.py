...
"""
you may encounter global_step=batch_number*2, that's because of the GAN's training need two step optimize.
so infact global_step=batch_number*2, but self.log will only log the batch_number, self.log_image will only log the global_step.
self.global_step will be the global_step.
so ignore the self.log step, just focus on the self.global_step.
if you use the resume, it will load the state_dict[global_step] as the self.global_step, it's correct
"""
